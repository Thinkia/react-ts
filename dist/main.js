...
const action_1 = __webpack_require__(/*! ../redux/action */ "./src/redux/action.ts");
class Add extends React.Component {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, " add "));
    }
}
const mapDispatchToPROPS = (dispatch) => {
    return {
        onClick: () => {
            dispatch(action_1.addItem());
        }
    };
};
exports.default = react_redux_1.connect(null, mapDispatchToPROPS)(Add);
...
class Delete extends React.Component {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, " delete "));
    }
}
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        onClick: () => {
            dispatch(action_1.deleteItem(ownProps.item.task));
        }
    };
};
exports.default = react_redux_1.connect(null, mapDispatchToProps)(Delete);


/***/ }),

/***/ "./src/components/Doing.tsx":
/*!**********************************!*\
  !*** ./src/components/Doing.tsx ***!
  \**********************************/
/*! no static exports found */
...
class Doing extends React.Component {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, "doing"));
    }
}
const mapDispatchToPROPS = (dispatch, ownProps) => {
    return {
        onClick: () => {
            dispatch(action_1.setDoing(ownProps.item.task));
        }
    };
};
exports.default = react_redux_1.connect(null, mapDispatchToPROPS)(Doing);
...
class Done extends React.Component {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, "done"));
    }
}
exports.default = react_redux_1.connect(null, (dispatch, ownProps) => {
    return {
        onClick: () => {
            dispatch(action_1.setDone(ownProps.item.task));
        }
    };
})(Done);
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const action_1 = __webpack_require__(/*! ../redux/action */ "./src/redux/action.ts");
class DoneAll extends React.PureComponent {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, " done all "));
    }
}
const mapDispatchToProps = (dispatch) => {
    return {
        onClick: () => {
            dispatch(action_1.doneAll());
        }
    };
};
exports.default = react_redux_1.connect(null, mapDispatchToProps)(DoneAll);
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "react");
const Delete_1 = __webpack_require__(/*! ./Delete */ "./src/components/Delete.tsx");
const Doing_1 = __webpack_require__(/*! ./Doing */ "./src/components/Doing.tsx");
const Done_1 = __webpack_require__(/*! ./Done */ "./src/components/Done.tsx");
const Todo_1 = __webpack_require__(/*! ./Todo */ "./src/components/Todo.tsx");
class Item extends React.Component {
    render() {
        const { item } = this.props;
        return (React.createElement("tr", null,
            React.createElement("td", null, item.task),
            React.createElement("td", null, item.describe),
            React.createElement("td", null, item.stage),
            React.createElement("td", null,
                React.createElement(Done_1.default, { item: item })),
            React.createElement("td", null,
                React.createElement(Doing_1.default, { item: item })),
            React.createElement("td", null,
                React.createElement(Todo_1.default, { item: item })),
            React.createElement("td", null,
                React.createElement(Delete_1.default, { item: item }))));
    }
}
...
class Todo extends React.Component {
    render() {
        return (React.createElement("button", { onClick: this.props.onClick }, " todo "));
    }
}
const mapDispatchProps = (dispatch, ownProps) => {
    return {
        onClick: () => {
            dispatch(action_1.setTodo(ownProps.item.task));
        }
    };
};
exports.default = react_redux_1.connect(null, mapDispatchProps)(Todo);
...
const Add_1 = __webpack_require__(/*! ./components/Add */ "./src/components/Add.tsx");
const DoneAll_1 = __webpack_require__(/*! ./components/DoneAll */ "./src/components/DoneAll.tsx");
const Item_1 = __webpack_require__(/*! ./components/Item */ "./src/components/Item.tsx");
const store_1 = __webpack_require__(/*! ./redux/store */ "./src/redux/store.ts");
;
class List extends React.Component {
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(DoneAll_1.default, null),
            React.createElement("table", { style: { border: '1px solid black' } },
                React.createElement("tbody", null, objects.map((item) => {
                    return (React.createElement(Item_1.default, { key: item.task, item: item }));
                })))));
    }
}
const mapStateToProps = (state) => {
...
const ConnectedList = react_redux_1.connect(mapStateToProps)(List);
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store_1.default },
    React.createElement(ConnectedList, null)), document.getElementById("example"));
...
exports.addItem = () => ({
    type: actionTypes_1.ADD_ITEM,
});
exports.deleteItem = (task) => ({
    type: actionTypes_1.DELETE_ITEM,
    task: task,
});
exports.doneAll = () => ({
    type: actionTypes_1.DONE_ALL,
});
exports.setDoing = (task) => ({
    type: actionTypes_1.SET_DOING,
    task: task,
});
exports.setTodo = (task) => ({
    type: actionTypes_1.SET_TODO,
    task: task,
});
exports.setDone = (task) => ({
    type: actionTypes_1.SET_DONE,
    task: task,
});
...
// 把所有的stage 设置为 done
exports.DONE_ALL = 'DONE_ALL';
// 把某个task 的 stage 设置为 todo
exports.SET_TODO = 'SET_TODO';
// 把某个task 的 stage 设置为 doing
exports.SET_DOING = 'SET_DOING';
// 把某个task 的 stage 设置 为 done 
...
Object.defineProperty(exports, "__esModule", { value: true });
const todos_1 = __webpack_require__(/*! ./todos */ "./src/redux/reducers/todos.ts");
exports.default = todos_1.default;
...
function default_1(state = initialState, action) {
    ...
    switch (action.type) {
        // 删除 指定task item
        case actionTypes_1.DELETE_ITEM: {
...
const reducers_1 = __webpack_require__(/*! ./reducers */ "./src/redux/reducers/index.ts");
